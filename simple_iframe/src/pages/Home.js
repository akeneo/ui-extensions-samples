            ...
            <Table>
                ...
                <Table.Body>
                    ...
                    {typeof uiExtensions === 'undefined' ? [0, 1, 2].map(() => <Table.Row>
                        ...
                        <Table.Cell>{uiExtension.uuid}</Table.Cell>
                        ...
                        <Table.Cell><Button level={'danger'} data-test={uiExtension.uuid} onClick={() => deleteProductTabUiExtension(uiExtension.uuid)}>Delete</Button></Table.Cell>
                    </Table.Row>)}
                </Table.Body>
            </Table>
